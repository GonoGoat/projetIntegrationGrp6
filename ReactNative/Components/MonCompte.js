               ...
               if (_verifyMail(this.state.newInfos[3]).state){
                   if (this.state.newInfos[2] == "M" || this.state.newInfos[2] == "F") {
                        if (this.state.mailVerified){
                            ...
                            this.setState({user : [{id: id, lastname : this.state.newInfos[0], firstname : this.state.newInfos[1], sexe : this.state.newInfos[2], mail : this.state.newInfos[3], phone :this.state.newInfos[4]}]})
